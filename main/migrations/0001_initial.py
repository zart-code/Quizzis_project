    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[
                    ...
                    ('text', 'Текстовый'),
                    ('number', 'Числовой')],
                    default='single', max_length=10, verbose_name='Тип вопроса')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                           related_name='game_participations', to=settings.AUTH_USER_MODEL,
                                           verbose_name='Игрок')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='participants',
                                              to='main.gamesession', verbose_name='Сессия')),
            ],
            options={
                'ordering': ['-score'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('time_limit', models.IntegerField(blank=True, help_text='Ограничение по времени в минутах',
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                               related_name='quizzes', to='main.category', verbose_name='Категория')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                    related_name='questions', to='main.quiz'),
        ),
        migrations.AddField(
            model_name='gamesession',
            name='quiz',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                    related_name='sessions', to='main.quiz', verbose_name='Квиз'),
        ),
        migrations.CreateModel(
            name='QuizResult',
            fields=[
                ...
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                           related_name='results', to='main.quiz')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('answer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                             to='main.answer', verbose_name='Выбранный ответ')),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                  related_name='answers', to='main.gameparticipant', verbose_name='Участник')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                              related_name='game_answers', to='main.gamesession', verbose_name='Сессия')),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                               related_name='game_answers', to='main.question', verbose_name='Вопрос')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('achievement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                                  related_name='user_achievements', to='main.achievement')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
