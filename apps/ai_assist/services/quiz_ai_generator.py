...
- Если вопрос подразумевает числовой ответ уточняй в каких единицах измерения он должен быть (например, "в километрах", "в градусах Цельсия").
- Уточняй что нужно сделать в вопросе (например, "выбери все правильные варианты", "укажи число", "выбери один вариант").
...
- В текстах вопроса не должно быть вариантов ответа, только вопрос в чистом виде
"""
...
18. поле text должно дословно совпадать с переданным вопросом
19. Треть вопросов должна быть числовыми, треть одиночными, треть множественными
20. Все факты и данные должны быть достоверными и проверяемыми.
21. НЕЛЬЗЯ придумывать факты, даты, числа, характеристики. НЕЛЬЗЯ придумывать научные термины
22. После создания вопросов и вариантов ответов ОБЯЗАТЕЛЬНО проверь варианты ответов на достоверность и корректность. Если есть есть ошибки, исправь. Только потом можно создавать JSON
