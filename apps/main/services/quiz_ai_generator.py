...
Правила:
- Вопросы должны быть конкретными, проверяемыми и интересными.
...
<<<<<<< HEAD
- В вопросах не должно быть подсказок на ответ, если это не прописано дальше в запрсое.
=======
...
6. timeLimit: от 10 до 120 секунд.
7. coefficient: от 1 до 3 (1=лёгкий, 2=средний, 3=сложный).
...
10. Сам оценивай сложность каждого вопроса и исходя из этого ставь коэфицент
...
13. Сам оценивай сколько времени давать на ответ исходя из длины и сложности вопроса
14. В названии квиза нельзя писать "квиз" или "викторина" и так далее
<<<<<<< HEAD
15. В multiple_choice ОБЯЗАТЕЛЬНО несколько правильных ответов
16. НИКОГДА не оставляй во вариантах ответах пустые ячейки или надписи-заглушики, например "Варинат D"
17. ОБЯЗАТЕЛЬНО ИСПОЛЬЗУЙ number? хотябы 30% вопросов
18. В вопросах не должно быть подсказок на ответ, если это не прописано дальше в запросе
19. Не меняй вопросы который в запросе
=======
15. Треть вопросов должна быть числовыми, треть одиночными, треть множественными
